...
void plotEdgeFit(int val = 4)
{
    TFile * f = TFile::Open("BC501A_bkgsub.root");
    TH1F * h1 = (TH1F*)f->Get(Form("ProtonCal%d",val));
    ...
    double C10 = maxBinCont*0.1;
    double C90 = maxBinCont*1;
    ...
    TLatex * text10 = new TLatex(L10*0.98,-maxBinCont*0.1,"L_{10}");
    TLatex * text50 = new TLatex(  L*0.98,-maxBinCont*0.1,"L");
    TLatex * text90 = new TLatex(L90*0.98,-maxBinCont*0.1,"L_{100}");
